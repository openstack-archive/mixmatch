...
def trim_endpoint(orig_path):
    """Removes the project_id and returns the correct endpoint."""
...
def get_conf_endpoint(sp, service):
...
@MEMOIZE_SESSION
def get_sp_endpoint(sp, service, project_id=None, version=None):
    """Return an endpoint for a service."""
    endpoint = get_conf_endpoint(sp, service)
