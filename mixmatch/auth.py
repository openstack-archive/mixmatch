...
def get_client():
    ...
    service_auth = identity.Password(
        auth_url=CONF.auth_opts.auth_url,
        username=CONF.auth_opts.username,
        password=CONF.auth_opts.password,
        project_name=CONF.auth_opts.project_name,
        project_domain_id=CONF.auth_opts.project_domain_id,
        user_domain_id=CONF.auth_opts.user_domain_id
    )
...
def get_local_auth(user_token):
    ...
    local_auth = identity.v3.Token(auth_url=CONF.auth_opts.auth_url,
                                   token=user_token,
