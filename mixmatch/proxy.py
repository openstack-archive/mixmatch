...
class RequestDetails(object):
    ...
    def __init__(self, method, orig_path, headers):
        self.path_field = path_split(orig_path)
        self.method = method
        self.service = get_service(self.path_field)
        self.version = utils.safe_pop(self.path_field)
        self.project_id = utils.pop_if_uuid(self.path_field)
        self.action = self.path_field[:]
        self.resource_type = utils.safe_pop(self.path_field)
        self.resource_id = utils.pop_if_uuid(self.path_field)
...
class RequestHandler(object):
    ...
    def __init__(self, method, path, headers):
        ...
        self.extensions = extend.get_matched_extensions(self.details.__dict__)
        self._set_strip_details(self.details.__dict__)
        ...
        for extension in self.extensions:
            extension.handle_request(self.details.__dict__)
