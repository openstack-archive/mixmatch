...
from mixmatch.config import LOG_image, LOG_volume, LOG_network, LOG, CONF, service_providers
...
class RequestHandler(object):
    ...
    def __init__(self, method, path, headers):
        ...
        LOG(self.details.service).info(format_for_log(title="Request to proxy",
            method=self.details.method, url=self.details.path,
