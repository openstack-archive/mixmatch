...
class RequestHandler(object):
    ...
    def _aggregate_forward(self):
        if ((self.details['aggregate'] and not CONF.aggregation) or
                (not self.details['aggregate'] and
                 not CONF.search_by_broadcast)):
