...
class BaseVolumeTest(tempest.test.BaseTestCase):
    ...
    def clear_volumes(cls):
        ...
        for volume in cls.volumes:
            try:
                cls.volumes_client.wait_for_resource_deletion(volume['volume']['id'])
            except Exception as e:
                print(e)
                pass
    ...
    def _create_volume_at_sp(cls, sp=None, name=None, size=1):
        ...
        volume = cls.volumes_client.create_volume_at_sp(volume=request_body, sp=sp)
    ...
    def create_server(cls, validatable=False, volume_backed=False,
        ...
        body, servers = compute.create_test_server(
            ...
            **kwargs)
        waiters.wait_for_server_status(cls.servers_client, body['id'], 'ACTIVE')
        cls.servers.extend(servers)
        return body

    @classmethod
    def attach_volume(cls, volume_id=None, server_id=None):
        return cls.servers_client.attach_volume(server_id=server_id, volumeId=volume_id)
